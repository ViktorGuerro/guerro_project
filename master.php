    ...
    <div class="master-controls">
        ...
        <div class="panel">
            ...
            <form id="dice-overlay-form">
                <div class="form-row">
                    <div class="form-field">
                        <label for="dice-entity-id" class="field-label">Кто бросает</label>
                        <select id="dice-entity-id"></select>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-field">
                        <label for="dice-label" class="field-label">Подпись броска</label>
                        <input id="dice-label" type="text" maxlength="255" placeholder="Атака / Урон / Проверка">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-field">
                ...
                <div class="form-row">
                    ...
                    <div class="form-field">
                        <label for="dice-total-preview" class="field-label">Итог</label>
                        <input id="dice-total-preview" type="text" value="0" readonly>
                    </div>
                </div>
                <div class="form-row">
                    <button type="submit">Показать бросок</button>
                    <button id="dice-hide-btn" type="button" class="secondary">Скрыть бросок</button>
                </div>
            </form>
        </div>
